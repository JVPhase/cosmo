      ...
      {activeTab === 'fleet' ? (
        <ScrollView contentContainerStyle={styles.content}>
          ...
          {visibleShips.map((ship) => {
            ...
            const canBuild =
              !isOwned &&
              canAffordCost(metals, ship.baseCost) &&
              !isBattleActive;
            const canRepair =
              isBroken &&
              canAffordCost(metals, ship.repairCost) &&
              !isBattleActive;
                ...
                >
                  ...
                  <View style={styles.shipInfo}>
                    ...
                    <View style={styles.shipStatsRow}>
                      <Text style={styles.shipMult}>
                        ×{ship.damageMultiplier} урон
                      </Text>
                      {isOwned && !isOnExpedition && (
                        <Text style={styles.shipTotalDmg}>
                          ⚔️ {totalShipDmg}/клик
                        </Text>
                      )}
                      {isOnExpedition && (
