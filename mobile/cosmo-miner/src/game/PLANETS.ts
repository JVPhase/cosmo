...
export const PLANETS = [
  ...
  // ── SECTOR 3 · ЗОНА ИЛЛЮЗИЙ ──
  {
    id: 11,
    sectorId: 3 as SectorId,
    name: "Мираго Прайм",
    icon: "🌈",
    image: require("../../assets/underconstraction.png"),
    unlocked: false,
    cost: 50_000_000,
    resource: "Мираж-ферит",
    color: "#7ecbd4",
    bonus: 500_000,
  ...
  },
  {
    id: 12,
    sectorId: 3 as SectorId,
    name: "Фантомная Вуаль",
    icon: "👻",
    image: require("../../assets/underconstraction.png"),
    unlocked: false,
    cost: 500_000_000,
    resource: "Фантом-титан",
    color: "#c490d1",
    bonus: 2_000_000,
  ...
  },
  {
    id: 14,
    sectorId: 3 as SectorId,
    name: "Глубины Миражей",
    icon: "🏜️",
    image: require("../../assets/underconstraction.png"),
    unlocked: false,
    cost: 50_000_000_000,
    resource: "Мираж-сплав",
    color: "#d4a17e",
    bonus: 50_000_000,
