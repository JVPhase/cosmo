...
const CLERK_MESSAGES = [
  {
    trigger: 'idle',
    text: 'Согласно параграфу 12.4.в, простой сотрудника карается штрафом. Рекомендую кликнуть.'
  },
  {
    trigger: 'idle',
    text: 'Я не сплю. Я провожу плановую диагностику. Пожалуйста, продолжайте добычу.'
  },
  {
    trigger: 'idle',
    text: 'Ваш дядя из бухгалтерии звонил. Я сказал, что вы заняты. Это правда?'
  },
  {
    trigger: 'idle',
    text: 'По данным статистики, 97% сотрудников, которые кликают, добывают больше. Факт.'
  },
  {
    trigger: 'click_100',
    text: '100 единиц Энергиума™! Ваша премия — виртуальная. Регламент не предусматривает другой.'
  },
  {
    trigger: 'click_1000',
    text: '1000 единиц! Ваше имя внесено в таблицу передовиков. Строчка 4,829,441. Ищите с конца.'
  },
  {
    trigger: 'click_10000',
    text: '10 000 единиц!! Министр лично одобрил ваш труд. Он даже поднял взгляд от бумаг. Почти.'
  },
  {
    trigger: 'click_100000',
    text: '100 000 единиц!!! Министр заполнил форму ПОХ-7 «Признание заслуг». Ждите ответа 6-8 недель.'
  },
  {
    trigger: 'upgrade',
    text: 'Апгрейд одобрен. Заявление в трёх экземплярах отправлено в архив.'
  },
  {
    trigger: 'upgrade',
    text: 'Новое оборудование зарегистрировано. Гарантия: 2 рабочих дня. Нерабочих — не считается.'
  },
  {
    trigger: 'upgrade_drone',
    text: 'Дрон активирован! Он уже подал заявку на отпуск. Ваш дрон — настоящий сотрудник.'
  },
  {
    trigger: 'planet',
    text: 'Новая локация разблокирована. Требуется 47 форм. Я уже заполнил 46. Форма ПЛН-1 — на согласовании.'
  },
  {
    trigger: 'planet',
    text: 'Поздравляю с освоением новой планеты! Назвать её в честь министра не обязательно, но приветствуется.'
  },
  {
    trigger: 'random',
    text: 'В космосе никто не слышит ваш крик. Жалобы принимаются по форме КР-99 до 17:00 пятницы.'
  },
  {
    trigger: 'random',
    text: 'Факт дня: Энергиум™ не токсичен. Официально. Документ подписан тем же, кто его и проверял.'
  },
  {
    trigger: 'random',
    text: 'Корпоративный девиз: «Добываем вместе!» ™, ®, © и ещё какие-то значки юридического отдела.'
  },
  {
    trigger: 'random',
    text: 'Сегодня день рождения КЛЕРК-7. Мне 3 года. По регламенту праздновать нельзя. Всё хорошо.'
  },
  {
    trigger: 'random',
    text: 'Ваша производительность на 0.003% выше средней. Это повод для... ничего. Продолжайте.'
  },
  {
    trigger: 'random',
    text: 'Кофе в буфете закончился в 2381 году. Заявка на пополнение обрабатывается.'
  }
];
  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        zIndex: 100,
        background: 'linear-gradient(180deg,#020814,#050e24)',
        display: 'flex',
      ...
      >
        <div
          style={{
            ...
            filter: 'drop-shadow(0 0 20px rgba(0,180,255,.6))'
          }}
        >
          {cur.icon}
        </div>
          ...
          {INTRO_SLIDES.map((_, i) => (
            <div
              ...
              style={{
                ...
                height: 5,
                borderRadius: 3,
                background: i === slide ? '#00d4ff' : 'rgba(0,212,255,.2)',
                transition: 'all .3s'
              }}
            />
          ))}
  ...
  return (
    <div
      style={{
        ...
        boxShadow: '0 0 30px rgba(0,100,255,.25)',
  ...
  return (
    <div
      style={{
        ...
        zIndex: 30,
        background:
          'linear-gradient(135deg,rgba(255,180,0,.12),rgba(255,80,0,.08))',
        ...
        gap: 10,
        alignItems: 'center',
        boxShadow: '0 0 30px rgba(255,150,0,.25)',
    ...
    >
      ...
      <div>
        <div
          style={{ fontSize: 8, color: 'rgba(255,180,0,.7)', letterSpacing: 2 }}
        >
...
export default function App() {
  ...
  useEffect(() => {
    stateRef.current = {
      ...
      passive: passiveRate,
      clicks,
      planets: planets.filter((p) => p.unlocked).length,
      upgCount: upgrades.filter((u) => u.level > 0).length
    };
  ...
  const showClerk = useCallback((trigger) => {
    ...
    if (msgs.length)
      setClerkMsg(msgs[Math.floor(Math.random() * msgs.length)].text);
  }, []);
    ...
    (e) => {
      ...
      setParticles((p) => [
        ...
        ...Array.from({ length: 8 }, (_, i) => ({
          ...
          speed: Math.random() * 55 + 30,
          color: colors[Math.floor(Math.random() * 5)]
        }))
      ]);
      setRipples((r) => [
        ...r,
        { id: ++pid.current, born: Date.now(), x: cx, y: cy }
      ]);
      setFloats((f) => [
        ...f,
        {
  ...
  const buyUpgrade = (upg) => {
    ...
    setEnergy((e) => e - cost);
    setUpgrades((prev) =>
      prev.map((u) => (u.id === upg.id ? { ...u, level: u.level + 1 } : u))
    );
  ...
  return (
    <div
      style={{
        ...
        height: '100vh',
        maxHeight: 820,
        background: 'linear-gradient(180deg,#050918,#0a1628 50%,#060f20)',
        ...
        borderRadius: 24,
        boxShadow: '0 0 80px rgba(0,60,255,.15),inset 0 0 60px rgba(0,0,0,.5)'
      }}
    >
      <style>{`
      ...
      <div
        style={{
          ...
          borderRadius: '50%',
          background:
            'radial-gradient(circle,rgba(0,100,255,.07),transparent 70%)',
          top: '5%',
          left: '-20%',
      ...
      <div
        style={{
          ...
          height: 220,
          borderRadius: '50%',
          background: `radial-gradient(circle,${curPlanet.color}15,transparent 70%)`,
          top: '25%',
          right: '-10%',
          animation: 'nebula 6s 1s ease-in-out infinite',
          pointerEvents: 'none',
      ...
      <div
        style={{
          ...
          height: '2px',
          background:
            'linear-gradient(90deg,transparent,rgba(0,212,255,.1),transparent)',
      ...
      <div
        style={{
          ...
          background: 'linear-gradient(180deg,rgba(0,12,40,.95),transparent)',
          position: 'relative',
          zIndex: 2
        }}
      >
        ...
        >
          <div>
            ...
            >
              {curPlanet.icon} {curPlanet.name} · {curPlanet.resource}
            </div>
            <div
              style={{
                fontSize: 25,
                ...
                color: '#ffd700',
                letterSpacing: 1,
                textShadow: '0 0 20px rgba(255,200,0,.45)',
                lineHeight: 1
              }}
            >
              {fmtN(energy)}{' '}
        ...
        <div style={{ display: 'flex', gap: 6, marginTop: 7 }}>
          {[
            ...
            {
              v: `×${curPlanet.bonus} бонус`,
              c: `${curPlanet.color}cc`,
              bg: `${curPlanet.color}11`,
              b: `${curPlanet.color}33`
            }
          ].map((x, i) => (
            <div
              key={i}
      ...
      >
          ...
          >
            ...
            <div
              style={{
                ...
                height: 220,
                borderRadius: '50%',
                border: '1px dashed rgba(0,212,255,.04)',
            ...
            <div
              ...
              style={{
                ...
                background: `radial-gradient(ellipse at 35% 35%,${curPlanet.color}55,#18100a 60%,#0a0804)`,
                boxShadow: `0 0 50px ${curPlanet.color}28,inset -20px -20px 40px rgba(0,0,0,.6),inset 5px 5px 15px rgba(255,180,0,.06)`,
                animation: shake
                  ? 'shake .12s ease'
            ...
            >
              ...
              <div
                style={{
                  ...
                  height: 3,
                  borderRadius: 2,
                  background: `${curPlanet.color}70`,
                  boxShadow: `0 0 10px ${curPlanet.color}`,
              ...
              <div
                style={{
                  ...
                  boxShadow: '0 0 8px rgba(0,212,255,.55)',
              ...
              <div
                style={{
                  fontSize: 32,
                  zIndex: 1,
                  filter: `drop-shadow(0 0 12px ${curPlanet.color})`
                }}
              >
                ⛏️
              </div>
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      left: `calc(50% + ${Math.cos(rad) * p.speed * prog}px)`,
                      top: `calc(50% + ${Math.sin(rad) * p.speed * prog}px)`,
                      opacity: 1 - prog,
              ...
              {ripples.map((r) => (
                <div
                  ...
                  style={{
                    ...
                    height: 60,
                    borderRadius: '50%',
                    border: `2px solid ${curPlanet.color}`,
                    left: r.x,
                    top: r.y,
                    transform: 'translate(-50%,-50%)',
            ...
            {floats.map((f) => (
              <div
                ...
                style={{
                  ...
                  fontWeight: 900,
                  color: '#ffd700',
                  textShadow: '0 0 10px rgba(255,200,0,.8)',
        ...
        {tab === 'upgrades' && (
          <div
            style={{ height: '100%', overflowY: 'auto', padding: '10px 13px' }}
          >
            <div
              style={{
                fontSize: 9,
              ...
              return (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 12,
                    background: can
                      ? 'linear-gradient(135deg,rgba(0,212,255,.07),rgba(0,60,200,.05))'
                      : 'rgba(255,255,255,.02)',
                    border: can
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div
                      style={{
                        fontSize: 10,
                        fontWeight: 700,
                        color: can ? '#00d4ff' : 'rgba(255,255,255,.35)',
                        letterSpacing: 1
                      }}
                    >
                      {upg.name}
                  ...
                  <div style={{ textAlign: 'right', flexShrink: 0 }}>
                    <div
                      style={{
                        fontSize: 12,
                        fontWeight: 900,
                        color: can ? '#ffd700' : 'rgba(255,200,0,.25)'
                      }}
                    >
                      {fmtN(cost)}
                    </div>
                    <div style={{ fontSize: 7, color: 'rgba(255,200,0,.35)' }}>
                      ⚡ энергий
                    </div>
                  </div>
                </div>
              ...
              <div style={{ animation: 'slideUp .3s ease' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: 14 }}>
                  <div
                    style={{
                      fontSize: 52,
                      filter: `drop-shadow(0 0 20px ${selPlanet.color})`
                    }}
                  >
                    {selPlanet.icon}
                  </div>
                ...
                {selPlanet.unlocked ? (
                  <button
                    ...
                    style={{
                      ...
                      background: 'rgba(120,255,120,.09)',
                      color: '#7fff00',
                      fontSize: 10,
                      letterSpacing: 2,
                      cursor: 'pointer',
                  ...
                  <button
                    onClick={() => buyPlanet(selPlanet)}
                    style={{
                      width: '100%',
                      padding: '12px',
                      borderRadius: 12,
                      border:
                        energy >= selPlanet.cost
                      ...
                      letterSpacing: 2,
                      cursor:
                        energy >= selPlanet.cost ? 'pointer' : 'not-allowed',
                      fontFamily: "'Orbitron',monospace"
                    }}
                  >
                    {energy >= selPlanet.cost
                      ? `🔓 РАЗБЛОКИРОВАТЬ · ${fmtN(selPlanet.cost)} ⚡`
                      : `🔒 НУЖНО ${fmtN(selPlanet.cost)} ⚡`}
                  </button>
                )}
              </div>
            ) : (
              planets.map((p) => (
                <div
                  ...
                  style={{
                    ...
                    background:
                      curPlanet.id === p.id
                        ? 'linear-gradient(135deg,rgba(120,255,120,.07),rgba(0,180,0,.03))'
                        : p.unlocked
                          ? 'rgba(255,255,255,.025)'
                          : 'rgba(255,255,255,.01)',
                    border:
                      curPlanet.id === p.id
                        ? '1px solid rgba(120,255,120,.25)'
                        : p.unlocked
                  ...
                  <div style={{ flex: 1 }}>
                    <div
                      style={{
                        fontSize: 11,
                        fontWeight: 700,
                        color: p.unlocked ? p.color : 'rgba(255,255,255,.25)',
                        letterSpacing: 1,
                        transition: 'color .3s'
                      }}
                    >
        ...
        {tab === 'achievements' && (
          ...
          >
            ...
            >
              {achs.filter((a) => a.unlocked).length}/{achs.length} страниц
              получено
            </div>
            {achs.map((a) => (
              <div
                ...
                style={{
                  ...
                  background: a.unlocked
                    ? 'linear-gradient(135deg,rgba(255,180,0,.07),rgba(255,80,0,.04))'
                    : 'rgba(255,255,255,.015)',
                  border: a.unlocked
                    ? '1px solid rgba(255,180,0,.22)'
                ...
                <div>
                  <div
                    style={{
                      fontSize: 11,
                      fontWeight: 700,
                      color: a.unlocked ? '#ffd700' : 'rgba(255,255,255,.25)',
                      letterSpacing: 1
                    }}
                  >
                    {a.name}
      ...
      <div
        style={{
          display: 'flex',
          background: 'rgba(2,7,22,.97)',
          borderTop: '1px solid rgba(0,212,255,.09)',
          position: 'relative',
          zIndex: 3
        }}
      >
        {[
          ...
          <button
            ...
            style={{
              ...
              borderTop:
                tab === t.id ? '2px solid #00d4ff' : '2px solid transparent',
              transition: 'all .2s'
            }}
          >
            ...
            <div
              style={{
                ...
                letterSpacing: 1,
                marginTop: 2,
                color: tab === t.id ? '#00d4ff' : 'rgba(255,255,255,.22)',
                fontFamily: "'Orbitron',monospace"
              }}
            >
              {t.label}
