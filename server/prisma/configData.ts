...
export const planetsData = {
  overrides: [
    { id: 1,  sectorId: 1, nameKey: 'planet.override.1.name',          icon: '🪨', imageKey: 'asteroid',         unlocked: true,  cost: 0,                bonus: 1,         resource: 'Энергиум™',      color: '#a09080', loreKey: 'planet.override.1.lore' },
    { id: 2,  sectorId: 1, nameKey: 'planet.override.2.name',          icon: '🔴', imageKey: 'mercury',          unlocked: false, cost: 500,              bonus: 2.5,       resource: 'Пламенит',       color: '#e74c3c', loreKey: 'planet.override.2.lore' },
    { id: 3,  sectorId: 1, nameKey: 'planet.override.3.name',            icon: '💎', imageKey: 'crystal',          unlocked: false, cost: 3000,             bonus: 6,         resource: 'Кристаллит',     color: '#3498db', loreKey: 'planet.override.3.lore' },
    { id: 4,  sectorId: 1, nameKey: 'planet.override.4.name',      icon: '🌫️', imageKey: 'omega',            unlocked: false, cost: 15000,            bonus: 15,        resource: 'Туманоид',       color: '#9b59b6', loreKey: 'planet.override.4.lore' },
    { id: 5,  sectorId: 1, nameKey: 'planet.override.5.name',        icon: '⭐', imageKey: 'sun',              unlocked: false, cost: 80000,            bonus: 50,        resource: 'Соляриум',       color: '#f39c12', loreKey: 'planet.override.5.lore' },
    { id: 6,  sectorId: 2, nameKey: 'planet.override.6.name',       icon: '⚫', imageKey: 'blackhole',        unlocked: false, cost: 0,                bonus: 120,       resource: 'Темниум',        color: '#8e44ad', loreKey: 'planet.override.6.lore' },
    { id: 7,  sectorId: 2, nameKey: 'planet.override.7.name',     icon: '💫', imageKey: 'neitronstar',      unlocked: false, cost: 0,                bonus: 350,       resource: 'Нейтрониум',     color: '#1abc9c', loreKey: 'planet.override.7.lore' },
    { id: 8,  sectorId: 2, nameKey: 'planet.override.8.name',  icon: '🌀', imageKey: 'nebula',           unlocked: false, cost: 0,                bonus: 1000,      resource: 'Парадоксит',     color: '#2980b9', loreKey: 'planet.override.8.lore' },
    { id: 9,  sectorId: 2, nameKey: 'planet.override.9.name',    icon: '⚡', imageKey: 'quantumfield',     unlocked: false, cost: 0,                bonus: 3000,      resource: 'Квантоний',      color: '#e67e22', loreKey: 'planet.override.9.lore' },
    { id: 10, sectorId: 2, nameKey: 'planet.override.10.name', icon: '🌌', imageKey: 'singularity',      unlocked: false, cost: 0,                bonus: 10000,     resource: 'Сингуларий',     color: '#c0392b', loreKey: 'planet.override.10.lore' },
    { id: 11, sectorId: 3, nameKey: 'planet.override.11.name',          icon: '🌈', imageKey: 'mirageprime',      unlocked: false, cost: 50_000_000,       bonus: 30_000,    resource: 'Мираж-ферит',    color: '#7ecbd4', loreKey: 'planet.override.11.lore' },
    { id: 12, sectorId: 3, nameKey: 'planet.override.12.name',       icon: '👻', imageKey: 'phantomveil',      unlocked: false, cost: 500_000_000,      bonus: 100_000,   resource: 'Фантом-титан',   color: '#c490d1', loreKey: 'planet.override.12.lore' },
    { id: 13, sectorId: 3, nameKey: 'planet.override.13.name',            icon: '🔊', imageKey: 'echorift',         unlocked: false, cost: 5_000_000_000,    bonus: 300_000,   resource: 'Эхо-иридий',     color: '#6dd49c', loreKey: 'planet.override.13.lore' },
    { id: 14, sectorId: 3, nameKey: 'planet.override.14.name',       icon: '🏜️', imageKey: 'depthsofmirages',  unlocked: false, cost: 50_000_000_000,   bonus: 1_000_000, resource: 'Мираж-сплав',    color: '#d4a17e', loreKey: 'planet.override.14.lore' },
    { id: 15, sectorId: 3, nameKey: 'planet.override.15.name',       icon: '🌑', imageKey: 'ghostofthevoid',   unlocked: false, cost: 500_000_000_000,  bonus: 3_000_000, resource: 'Пустот-титан',   color: '#8090d4', loreKey: 'planet.override.15.lore' },
  ],
  zoneThemes: [
