...
// ── characters ────────────────────────────────────────────────────────────────
// Static character metadata served via /dialogues. Text is Russian; locale
// strings for sector dialogues live in the LocaleBundle (dialogues namespace).
export const charactersData = [
  {
    ...
    icon: '🌟',
    greeting: 'Эй. Я Лиэн. Видела твой маршрут — немного кривовато, но жить будешь.\nЯ тут часто болтаюсь, буду писать иногда. Без повода, просто если будет что сказать.\nНе жди длинных писем — я в движении.',
    garbledMessage: '...слы——шь? Я...—— ...здесь...—— ...маршр——ут...—— ...10...——...опас——но...—— ...не...——...остор——ожно...',
    messages: [
    ...
    metalDealIntro: 'Слушай, ты сейчас в третьем секторе — видел эти новые кристаллы? Кристалл Пустоты и Осколок Эха. Они идут в боевые модули — Ядро Всплеска, Варп-Привод, Глаз Фантома. Без них здесь будет тяжело, поверь.\n\nЯ несколько месяцев назад нашла тут один склад. Металлов — с запасом. Могу поделиться.',
    metalDealOffer: 'Отдам тебе 15 Кристаллов Пустоты и 15 Осколков Эха. За 500 энергиума. Не торгуйся — это честно.\n\nСкажешь «возьму» — переброшу сразу. Скажешь «нет» — ладно, сам добудешь. Но это быстрее.',
  },
  {
    id: 'riva',
    name: 'Рива',
    ...
    icon: '🔧',
    greeting: 'О, новый пилот. Отлично. Я Рива, я чиню то, что другие называют «нечинимым».\nБуду иногда писать — не потому что скучно, а потому что ты явно нуждаешься в технической поддержке.\nБез обид. Все нуждаются.',
    garbledMessage: '...при——ём?...—— ...систе——мы...—— ...перегру——зка...—— ...держи——сь...—— ...поч——иню...',
    messages: [
    ...
    metalDealIntro: 'Слушала данные из сектора 3. Там два новых материала — Кристалл Пустоты и Осколок Эха. Из них собираются модули: Ядро Всплеска, Варп-Привод, Глаз Фантома. Без них ты теряешь серьёзные боевые опции. Это не мнение, это технический факт.\n\nЧинила несколько кораблей, которые заходили в этот сектор раньше. Кое-что с них осталось на складе.',
    metalDealOffer: '15 Кристаллов Пустоты, 15 Осколков Эха. 500 энергиума. Это не дорого — я говорю как специалист.\n\nИ нет, бесплатно не дам. Расходники стоят денег. Но предложение честное.',
  },
  {
    id: 'graves',
    name: 'Грейвс',
    ...
    metalDealIntro: 'Изучил сектор 3 по старым делам. Там два материала: Кристалл Пустоты и Осколок Эха. Перерабатываются в боевые модули — Ядро Всплеска, Варп-Привод, Глаз Фантома. Без них позиция проигрышная.\n\nЗа годы работы кое-что конфисковал. Часть до сих пор в хранилище. Предлагаю сделку.',
    metalDealOffer: '15 Кристаллов Пустоты и 15 Осколков Эха. Цена — 500 энергиума. Это не взятка, это деловое предложение.\n\nОткажешься — твоё право. Добудешь сам. Но это быстрее.',
  },
  {
    id: 'alex',
    name: 'Алекс',
    ...
    garbledMessage: '...соглас——но...—— ...данн——ым...—— ...рекомен——дую...—— ...осторо——жн...—— ...с уваже——ни...',
    messages: [
    ...
    metalDealIntro: 'В секторе 3 присутствуют два новых материала: Кристалл Пустоты и Осколок Эха. Они являются компонентами для производства модулей — Ядро Всплеска, Варп-Привод, Глаз Фантома. Именно эти модули определяют эффективность в данном секторе.\n\nНаши аналитики рекомендуют обеспечить запас до входа в активные зоны. Я могу это организовать.',
    metalDealOffer: '15 единиц Кристалла Пустоты и 15 единиц Осколка Эха. Стоимость: 500 энергиума. Ниже рыночной — в качестве жеста доброй воли.\n\nУсловия простые: согласие или отказ. Никаких дополнительных обязательств.',
  },
];
