...
export type AchievementTargetData =
  | { type: 'totalAtLeast' | 'passiveAtLeast' | 'clicksAtLeast' | 'upgCountAtLeast' | 'planetsAtLeast' | 'battlesWonAtLeast' | 'battleWinStreakAtLeast' | 'researchCountAtLeast' | 'allMetalsAtLeast' | 'playerLevelAtLeast'; value: number }
  | { type: 'battleCondition'; conditionKey: string }
  | { type: 'metalAtLeast'; metalId: string; value: number };

export type AchievementData = {
  id: number;
  target: AchievementTargetData;
};

export const ACHIEVEMENTS_DATA: readonly AchievementData[] = [
  // ── Добыча ──────────────────────────────────────────────────────────
  { id: 1,  target: { type: 'totalAtLeast',      value: 10 } },
  { id: 2,  target: { type: 'totalAtLeast',      value: 1_000 } },
  { id: 3,  target: { type: 'totalAtLeast',      value: 10_000 } },
  { id: 4,  target: { type: 'passiveAtLeast',    value: 10 } },
  { id: 5,  target: { type: 'planetsAtLeast',    value: 3 } },
  { id: 6,  target: { type: 'clicksAtLeast',     value: 500 } },
  { id: 7,  target: { type: 'totalAtLeast',      value: 100_000 } },
  { id: 8,  target: { type: 'upgCountAtLeast',   value: 5 } },
  { id: 9,  target: { type: 'clicksAtLeast',     value: 100 } },
  { id: 10, target: { type: 'clicksAtLeast',     value: 2_000 } },
  { id: 11, target: { type: 'clicksAtLeast',     value: 10_000 } },
  { id: 12, target: { type: 'totalAtLeast',      value: 500_000 } },
  { id: 13, target: { type: 'totalAtLeast',      value: 1_000_000 } },
  { id: 14, target: { type: 'totalAtLeast',      value: 10_000_000 } },
  ...
  // ── Клики: расширение ───────────────────────────────────────────────
  { id: 23, target: { type: 'clicksAtLeast',     value: 50_000 } },
  { id: 24, target: { type: 'clicksAtLeast',     value: 100_000 } },
  { id: 25, target: { type: 'clicksAtLeast',     value: 500_000 } },
  { id: 26, target: { type: 'clicksAtLeast',     value: 1_000_000 } },
  // ── Планеты: расширение ─────────────────────────────────────────────
  ...
  { id: 33, target: { type: 'passiveAtLeast',    value: 1_000 } },
  { id: 34, target: { type: 'passiveAtLeast',    value: 10_000 } },
  { id: 35, target: { type: 'passiveAtLeast',    value: 100_000 } },
  { id: 36, target: { type: 'passiveAtLeast',    value: 1_000_000 } },
  ...
  { id: 43, target: { type: 'battlesWonAtLeast', value: 1_000 } },
